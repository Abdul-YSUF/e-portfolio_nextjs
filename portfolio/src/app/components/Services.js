...
const services = [
  { title: "DÉVELOPPEMENT WEB", imageService: "wds.webp", colorClass: "canva", description: "Développement front-end et back-end de sites web et gestion de CMS." },
  //{ title: "UI/UX", colorClass: "ui-ux", description: "Design d'interfaces ergonomiques et intuitives." },
  { title: "CONSEIL", imageService: "advice.webp", colorClass: "figma", description: "Prototypage rapide pour vos projets digitaux." },
  //{ title: "FIGMA", colorClass: "figma", description: "Design collaboratif et création de maquettes." },
  { title: "SEO et ACCESSIBILITÉ", imageService: "seoetacc.webp", colorClass: "wordpress", description: "Optimisation SEO et accessibilité pour améliorer la visibilité de votre site web." },
